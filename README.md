...
```
This must match the amount of equivalent seconds in the candle chart that you've selected. 
...
```
```1566789720``` or Sun Aug 25 2019 23:22:00 GMT-0400 (Eastern Daylight Time) is the furthest back that kucoin's API will go. You can choose any date after ```1566789720``` but it needs to be converted into UTC seconds. A link to help you with the conversion has been provided below.
